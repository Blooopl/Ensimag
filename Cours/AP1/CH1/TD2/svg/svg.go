...
func debutImageSVG(largeur, hauteur float64) string {
	return fmt.Sprint("<svg xmlns=\"http://www.w3.org/2000/svg\" version=\"1.1\" width=\"",
...
// Un groupe SVG permet de factoriser certains paramètres, comme la couleur et l'épaisseur du
// trait ou la couleur de remplissage des formes.
...
// Retourne la chaîne decrivant un cercle SVG, en précisant les coordonnées de son centre, ainsi
// que son rayon.
...
// Retourne la chaîne décrivant un rectangle SVG, en précisant le point en haut à gauche,
// la largeur et hauteur du rectangle, ainsi que la couleur du fond.
...
// Retourne la chaîne décrivant un texte SVG, en précisant sa position, la taille de la police
// et bien sûr le texte en question.
