...
#########################
#On reprend la grammaire agrementé des arguments suivants :
"""
↓ : Attribut descendants
↑ : Attribut Synthétisés
l : la liste des résultats déjà calculés.
...
Exp0 ↓l ↑n    -> NUM ↑n
               ...
               | ( Exp5 ↓l ↑n )
"""
#On rajoute les paramètres des fonctions en suivant la logique décrit dans le cours :

###La structure globale est la même pour chaque fonction
"""def symbole_non_terminal(  Paramètre_descendants  (PD)  ):

    Si le carractère suivant est dans :
        Directeurs N°1:
            règle n°1
            Temp1 = symbole_NT_1( PD_1 )
            Temp2 =symbole_NT_2( PD_2 )
            ...
