...
## A changer : commenter le résultat de la commande var
var(x)
```
...
```{r}
curve(la_fonction_ell_de_theta, 
      xname = "theta", 
...
hat_theta_SB = ca_y_est_c_est_debiaise
...
Calculer la variance des estimateurs  $\hat\theta_{\rm SB}$ et $\hat\theta_{\rm MV}$. 
En déduire que les estimateurs sont convergents. 
